...
class _HomePageState extends State<HomePage> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Expanded(child: _action(Icons.route, 'Маршрут')),
                  Expanded(
                    child: _action(
                  ...
                  Expanded(child: _action(Icons.bookmark, 'Места')),
                ],
              ),
            ),
          ),
  ...
  Widget _action(IconData icon, String text) {
    return InkWell(
      onTap: () => setState(() {
        tab = text == 'Транспорт' ? 1 : 0;
      }),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Icon(icon, color: const Color(0xFFFF4B4B)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _field(Icons.radio_button_checked, 'Откуда'),
            const SizedBox(height: 8),
            _field(Icons.location_on, 'Куда'),
            ...
            const ListTile(
              ...
              title: Text('Метро'),
              subtitle: Text('12 мин · 1 пересадка'),
            ),
            const ListTile(
              leading: Icon(Icons.directions_bus),
              title: Text('Автобус'),
              subtitle: Text('18 мин · без пересадок'),
            ),
          ],
        ),
      ),
